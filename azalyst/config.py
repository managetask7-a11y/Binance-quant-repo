...
GOLD_COINS = [
    "MSTR/USDT:USDT", "SWARMS/USDT:USDT", "HYPE/USDT:USDT",
    "VIRTUAL/USDT:USDT", "SKYAI/USDT:USDT", "BSB/USDT:USDT", "LAB/USDT:USDT", 
    "BTC/USDT:USDT", "ETH/USDT:USDT", "SOL/USDT:USDT", "ADA/USDT:USDT", 
    "M/USDT:USDT", "LINK/USDT:USDT", "BZ/USDT:USDT", "BNB/USDT:USDT", 
    "XRP/USDT:USDT", "LTC/USDT:USDT", "DOT/USDT:USDT", "MATIC/USDT:USDT", 
    "BCH/USDT:USDT"
]
