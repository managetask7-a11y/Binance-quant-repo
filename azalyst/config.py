...
EXCLUDE_SYMBOLS = {
    ...
    "UNI/USDT:USDT", "XLM/USDT:USDT", "LINK/USDT:USDT", "TAO/USDT:USDT", 
    "SNX/USDT:USDT", "ACT/USDT:USDT", "PIEVERSE/USDT:USDT", "SOL/USDT:USDT", 
    "TRUMP/USDT:USDT", "HYPE/USDT:USDT", "SKYAI/USDT:USDT", "EIGEN/USDT:USDT",
}

GOLD_COINS = [
    "TRX/USDT:USDT", "SKYAI/USDT:USDT", "EIGEN/USDT:USDT",
]

LONG_ONLY_COINS = [
    "BEAT/USDT:USDT", "JTO/USDT:USDT", "KAITO/USDT:USDT", "ZEREBRO/USDT:USDT",
    "MSTR/USDT:USDT", "XAU/USDT:USDT", "AGLD/USDT:USDT", "ALLO/USDT:USDT",
    "MAGMA/USDT:USDT", "XAG/USDT:USDT",
]

SHORT_ONLY_COINS = [
    "CL/USDT:USDT", "GUA/USDT:USDT", "SLX/USDT:USDT", "ID/USDT:USDT",
    "TAO/USDT:USDT", "XLM/USDT:USDT", "SOL/USDT:USDT",
]
