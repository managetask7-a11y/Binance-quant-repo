...
EXCLUDE_SYMBOLS = {
    ...
    "UNI/USDT:USDT", "LINK/USDT:USDT", "SNX/USDT:USDT", "ACT/USDT:USDT",
    "PIEVERSE/USDT:USDT", "TRUMP/USDT:USDT", "HYPE/USDT:USDT",
    "XLM/USDT:USDT", "TAO/USDT:USDT", "SOL/USDT:USDT", "ID/USDT:USDT", "SKYAI/USDT:USDT",
}
...
LONG_ONLY_COINS = [
    "JTO/USDT:USDT", "SYN/USDT:USDT", "BSB/USDT:USDT", "ETH/USDT:USDT",
    "NEAR/USDT:USDT", "XAU/USDT:USDT", "MSTR/USDT:USDT", "SKYAI/USDT:USDT",
    "LINK/USDT:USDT", "ZEREBRO/USDT:USDT", "AGLD/USDT:USDT", "KAITO/USDT:USDT",
    "BTC/USDT:USDT", "MAGIC/USDT:USDT", "XMR/USDT:USDT", "SOL/USDT:USDT",
]

SHORT_ONLY_COINS = [
    "BCH/USDT:USDT", "CL/USDT:USDT", "ACT/USDT:USDT", "GUA/USDT:USDT",
]
