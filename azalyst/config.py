...
LONG_ONLY_COINS = [
    ...
    "MAGMA/USDT:USDT", "XAG/USDT:USDT", "EIGEN/USDT:USDT", "PENGU/USDT:USDT",
]

SHORT_ONLY_COINS = [
    "CL/USDT:USDT", "GUA/USDT:USDT", "SLX/USDT:USDT",
    "TAO/USDT:USDT", "XLM/USDT:USDT", "UNI/USDT:USDT", "SUI/USDT:USDT",
]
